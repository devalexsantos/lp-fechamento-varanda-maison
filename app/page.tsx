...
export default function Home() {
  return (
    <div className="flex flex-col">
      <Header />
      <div className="flex flex-col items-center gap-3 bg-primary text-center px-6 pt-10 pb-8">
        ...
        <Image src="/arrow-down.svg" alt="Arrow Down" width={50} height={50} className="mt-4" />
      </div>
      <NegativePoints />
      <PositivePoints />
      <Gallery />
