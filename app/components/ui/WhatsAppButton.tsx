...
export function WhatsAppButton({ color }: WhatsAppButtonProps) {
  return (
    <Link data-color={color} href="https://web.whatsapp.com/send?phone=5571999993553" target="_blank" className="flex w-full max-w-[350px] items-center gap-2 justify-center rounded-xl 
