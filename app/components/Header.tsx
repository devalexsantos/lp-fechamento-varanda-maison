...
export function Header() {
  return (
    <div className="min-h-[50vh] w-full flex flex-col bg-[url('/bg-hero.png')] bg-cover items-center relative">
      <div className="mt-4 flex w-full items-center justify-between gap-3 bg-[#185794] bg-opacity-90 p-6">
        <h1 className="text-2xl leading-8 text-white font-bold w-full max-w-[300px]">Quer o melhor <strong className="text-[#FE9821]">fechamento de varanda</strong> do Brasil?</h1>
