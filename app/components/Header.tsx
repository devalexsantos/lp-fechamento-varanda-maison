...
export function Header() {
  return (
    <div className="min-h-[50vh] w-full flex flex-col bg-[url('/bg-hero.png')] md:bg-[url('/bg-header.jpg')] bg-cover items-center relative"> <div className="mt-4 flex w-full items-center justify-between gap-3 bg-[#185794] bg-opacity-90 p-6">
