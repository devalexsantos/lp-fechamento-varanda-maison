export function ProTips() {
  return (
    <div className="w-full flex flex-col gap-4 px-4 py-12 text-primary">
      <h3 className="w-full text-3xl font-black text-center">Os melhores profissionais indicam <strong className="text-orange">Reiki</strong></h3>
