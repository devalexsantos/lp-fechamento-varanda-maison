...
const positivePoints = [
  ...
  "Vedação contra: ruídos externos, salitre, poluição, chuvas e ventas",
    ...
    <div className="flex flex-col bg-white px-4 pt-8 pb-12 gap-8">
...

      {
        positivePoints.map((point, index) => (
          <div key={index} className="flex flex-col items-center gap-2 bg-primary px-8 py-4 rounded-2xl shadow-2xl">
